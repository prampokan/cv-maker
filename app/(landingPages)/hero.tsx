  ...
  return (
    <div className="w-full flex justify-center pt-44 pb-20 px-5 sm:px-0">
      <div className="w-[70rem] h-full flex flex-col justify-center items-center">
        <h1 className="text-4xl sm:text-6xl font-bold tracking-tighter w-full sm:w-[30rem] text-center leading-tight bg-gradient-to-l from-zinc-900 to-zinc-400 bg-clip-text text-transparent">
          Built your CV with just few clicks.
        </h1>
        <p className="w-full sm:w-[30rem] text-center text-xl my-10 text-zinc-500 leading-relaxed">
